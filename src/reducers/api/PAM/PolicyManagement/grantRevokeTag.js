...
const NAME = 'PAM_GRANT_REVOKE_TAG';

/**************************************************
 * ambacc244 - PAM role에 정책을 부여
 **************************************************/
const grantAction = createAsyncThunk(
	...
	async (payload, {getState}) => {
		...
		const response = await Axios.post(
			`/open-api/v1/pam/tags/${payload.tagName}/policies`,
			{
...
const revokeAction = createAsyncThunk(
	...
	async (payload, {getState}) => {
		...
		const response = await Axios.delete(`/open-api/v1/pam/tags/policies`, {
			headers: {},
			params: {
...
/**************************************************
 * ambacc244 - PAM role에 부여된 규칙/정책을 조회
 **************************************************/
...
export default PAM_GRANT_REVOKE_TAG;
